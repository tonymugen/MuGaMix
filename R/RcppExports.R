...
testLpostNR <- function(yVec, d, Npop, theta, lnP, ind, lowerLimit, upperLimit, incr) {
    .Call(`_MuGaMix_testLpostNR`, yVec, d, Npop, theta, lnP, ind, lowerLimit, upperLimit, incr)
}
